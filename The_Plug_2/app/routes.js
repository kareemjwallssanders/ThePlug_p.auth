...
// normal routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        db.collection('snk').find().toArray((err, result) => {
...
// message board routes ========================================================
    ...
    app.post('/messages', (req, res) => {
      db.collection('snk').save({name: req.body.name, msg: req.body.msg, thumbUp: 0, thumbDown:0}, (err, result) => {
        if (err) return console.log(err)
    ...
    app.delete('/messages', (req, res) => {
      db.collection('snk').findOneAndDelete({name: req.body.name, msg: req.body.msg}, (err, result) => {
